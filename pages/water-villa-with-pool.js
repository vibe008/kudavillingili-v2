...
export const getServerSideProps = async () => {
	...
	const data = {
		...
		seo_title:"Maldives Resort with Largest Private Pools | Water Villa with Largest Private Pools | Maldives Hotels with Large Private Pools ",
		seo_description:"Unwind in style and complete privacy at Kuda Villingili's Water Villa with the largest private pool in the area. Book your stay for ultimate relaxation with ocean views."
