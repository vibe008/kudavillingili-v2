...
export const ExperienceTitleSmallTextMobile = styled.h3`
	color: #fff;
    font-weight: 400;
    font-size: 14px;
    text-align: center;
...
export const MeetDescription = styled.div`
	...
	${ props => props.paddingLeft && `
		padding-left: ${ props.paddingLeft ? props.paddingLeft : props.paddingLeft }
	`};	

	${ props => props.paddingRight && `
		padding-right: ${ props.paddingRight ? props.paddingRight : props.paddingRight }
	`};
